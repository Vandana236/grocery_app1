...
import 'package:grocery_onlineapp/baseurlg/languagecubit/custom_button.dart';
import 'package:grocery_onlineapp/baseurlg/languagecubit/entry_field.dart';
...
import 'package:grocery_onlineapp/models/beansmodel/citybean.dart';
import 'package:grocery_onlineapp/models/beansmodel/statebean.dart';
                      ...
                      child: DropdownButton<StateDataBean>(
                        ...
                        onChanged: (valued) {
                          setState(() {
                            ...
                            socityData = valued.society_id;
                            print('soietydata'+valued.society_id.toString());
