    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
            icon: Icon(
              Icons.keyboard_arrow_left_sharp,color: Colors.black,
              size: 30,
            ),
            onPressed: () {
                ...
                children: [
                  Padding(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                          text: '${locale.veri2}\n',
                          style: TextStyle(fontSize: 18,fontWeight: FontWeight.w800,color: Colors.black,letterSpacing: 1.2),
                          children: [
                            TextSpan(
                              text: '${locale.veri3} +$country_code$user_phone',
                              style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.black,letterSpacing: 1.1),
                            )
                          ]
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      defaultBorderColor: Colors.red.withOpacity(0.5),
                      hasTextBorderColor: Colors.red.withOpacity(0.5),
...
//                    highlightAnimation: true,
                      highlightAnimationBeginColor: Colors.red.withOpacity(0.5),
                      highlightAnimationEndColor: Colors.red.withOpacity(0.5),
                      keyboardType: TextInputType.number,
                    ),
                  ),
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: locale.resend+'!',
                              style: TextStyle(fontSize: 13,fontWeight: FontWeight.w600,color: Colors.red,letterSpacing: 1.1),
                            )
                          ]
                      ),
                    ),),
